...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\FavoriteMovie\\Presentation\\Rest\\V1\\DeleteFavoriteMovieController' => 'getDeleteFavoriteMovieControllerService',
            'App\\FavoriteMovie\\Presentation\\Rest\\V1\\GetAllFavoriteMovieController' => 'getGetAllFavoriteMovieControllerService',
            'App\\FavoriteMovie\\Presentation\\Rest\\V1\\PostFavoriteMovieController' => 'getPostFavoriteMovieControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\IndexController', 'App\\FavoriteMovie\\Presentation\\Rest\\V1\\DeleteFavoriteMovieController', 'App\\FavoriteMovie\\Presentation\\Rest\\V1\\GetAllFavoriteMovieController', 'App\\FavoriteMovie\\Presentation\\Rest\\V1\\PostFavoriteMovieController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $b = ($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Entity'), (\dirname(__DIR__, 4).'/src/FavoriteMovie/Infrastructure/DB/SQLite/Entity')], true));

        $a->addDriver($b, 'App\\Entity');
        $a->addDriver($b, 'App\\FavoriteMovie\\Infrastructure\\DB\\SQLite\\Entity');

        $instance->setEntityNamespaces(['App' => 'App\\Entity', 'FavoriteMovie' => 'App\\FavoriteMovie\\Infrastructure\\DB\\SQLite\\Entity']);
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\FavoriteMovie\\Infrastructure\\DB\\SQLite\\Repository\\FavoriteMovieRepository' => ['privates', 'App\\FavoriteMovie\\Infrastructure\\DB\\SQLite\\Repository\\FavoriteMovieRepository', 'getFavoriteMovieRepositoryService', true],
        ], [
            'App\\FavoriteMovie\\Infrastructure\\DB\\SQLite\\Repository\\FavoriteMovieRepository' => '?',
        ])));
